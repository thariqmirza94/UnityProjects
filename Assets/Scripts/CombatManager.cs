...
public class CombatManager : MonoBehaviour
{
    ...
    public void StartBattle()
    {
        ...
        _combatHud.OnHealthChange(_player.curHP, _player.maxHp, true);
        _combatHud.OnHealthChange(_monster.cur_hp, _monster.max_hp, false);
        ...
        RoomBase battleRoom = _interaction.currentBattleRoom;
